export function RatingBar(){
  ...
  <div>
    <dd className="flex items-center mb-2">
      <span className="text-xs font-medium me-2 w-4">5</span>
    ...
    <dd className="flex items-center mb-2">
      <span className="text-xs font-medium  me-2 w-4">4</span>
      <div className="w-full rounded-sm h-1.5 bg-slate-300">
        <div
          className="rounded-sm"
    ...
    <dd className="flex items-center mb-2">
      <span className="text-xs font-medium  me-2 w-4">3</span>
      <div className="w-full rounded-sm h-1.5 bg-slate-300">
        <div
          className="rounded-sm"
    ...
    <dd className="flex items-center mb-2">
      <span className="text-xs font-medium  me-2 w-4">2</span>
      <div className="w-full rounded-sm h-1.5 bg-slate-300">
        <div
          className="rounded-sm"
  ...
  <div>
    <dd className="flex items-center">
      <span className="text-xs font-medium me-2 w-4">1</span>
      <div className="w-full rounded-sm h-1.5 bg-slate-300">
        <div
          className="rounded-sm"
